...
function MediaPage() {
  ...
  return (
    <Box sx={{ overflow: "scroll" }}>
      ...
      >
        <Box style={{ margin: "5%", cursor: "pointer" }} onClick={handleClickM1}>
        ...
        <Box style={{ margin: "5%", cursor: "pointer" }} onClick={handleClickM2}>
          <Typography style={styles.mptext}>
        ...
        <Box style={{ margin: "5%", cursor: "pointer" }} onClick={handleClickM3}>
          <Typography style={styles.mptext}>
            ...
            <Box style={{ margin: "5%", cursor: "pointer" }} onClick={handleClickM4}>
          <Typography style={styles.mptext}>
          ...
          <Box style={{ margin: "5%", cursor: "pointer" }} onClick={handleClickM6}>
          <Typography style={styles.mptext}>
          ...
          <Box style={{ margin: "5%", cursor: "pointer" }} onClick={handleClickM7}>
          <Typography style={styles.mptext}>
          ...
          <Box style={{ margin: "5%", cursor: "pointer" }} onClick={handleClickM8}>
          <Typography style={styles.mptext}>
